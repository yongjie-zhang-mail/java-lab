      ...
      export PYTHONPATH=$SPARK_HOME/python:$SPARK_HOME/lib/spark-assembly.jar
...
export YARN_TIMELINESERVER_OPTS="$YARN_TIMELINESERVER_OPTS -server -Xms4096M -Xmx4096M -XX:PermSize=256M -XX:MaxPermSize=256M -XX:NewRatio=2 -XX:+UseParNewGC -XX:ParallelGCThreads=8 -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:+CMSClassUnloadingEnabled -XX:SoftRefLRUPolicyMSPerMB=0 -XX:+UseCompressedOops -XX:+UseCMSCompactAtFullCollection -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=60"
